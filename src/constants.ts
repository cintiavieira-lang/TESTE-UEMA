...
export const PRODUCTS: Product[] = [
  {
    id: '1',
    name: 'Açaí Power',
    description: 'Açaí cremoso, xarope de guaraná e granola',
    price: 14.50,
  ...
  },
  {
    id: '2',
    name: 'Cupuaçu Gelado',
    description: 'Polpa exótica de cupuaçu misturada com guaraná gelado',
    price: 13.00,
...
export const ADDONS = [
  { name: 'Castanha Extra', price: 2.00, image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDFf2Kbqp4d5OwnbYmmtP9GhxfVxy12DAZ7cM3ER_CJsmSuOMiIhgAIu8pGMDF7Q9eCWD2LdX5-q3uZtUgnMCsjPa1gC_pVfAb-1hLHCxLa3Jki7j61ss9jyVd6MTumGBgyx7iAQ9nbRqSlGOs64bfyQIPe-Alz17jjVrUiQbYpRPM3abvbTy9dj5AtteTLPhBbfqPXirgds3d3ZkAk8nplednOxU3hT1gH-F7oSD9p6s6Xm7rZa362a4y-DWUQ6dB-_fzEUhVrx-tY' },
  { name: 'Leite em Pó', price: 1.50, image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCwemma8R5eYGLdGCFc5VhqoeZV8geFAlEY5dpl0O_BgVSMHrXRVpJm1bmHcLqSEhewQMZFI1984J8Pnn_PJFE7GsZT5En3pc8ul2-JCJSTwqp8-uXM2bmvwIXbXXVNmbsckvRyYO-C-yFuRALXCVvV-W3hFhBlKy6aEyOdWb5N_oKJejV4bkcLN6mkV91AipAWBLfnfLBfWaT6SRXCu3RtoBsxJghGNSEC4idjlE4GW2b4DUEMORQ-tWiE5a9gF5mTf473_rxsloCV' },
  { name: 'Granola com Mel', price: 1.00, image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAQwAdWNV3bRZLnn_-XKe99Vh0SIhEvcbZMtLIBEC5bfv5u81cHvdAcIOOvBwcuwXaD0N3-2_bdAAb3BVI55BK8og1NoFiFXSNX6bObwoDEMkkhMM2bbUVkmEg8RSLG24_9AZi-YxOhoGW7b-zNES9VaNOOynTsUkOgpQ5HWpxTYnX0gxliirbq6c6lJm0UZlfunHm964pc0bx1lxwFCSdK4nx_BuJSkGfmX3KVrfRzIoVnwbu1hyOGprfMrGHp9Jz4mb4gDdKxrIsP' },
];
